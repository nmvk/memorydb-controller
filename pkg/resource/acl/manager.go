...
// +kubebuilder:rbac:groups=memorydb.services.k8s.aws,resources=acls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=memorydb.services.k8s.aws,resources=acls/status,verbs=get;update;patch
