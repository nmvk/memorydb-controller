...
// +kubebuilder:rbac:groups=memorydb.services.k8s.aws,resources=users,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=memorydb.services.k8s.aws,resources=users/status,verbs=get;update;patch
